# Generated by Django 4.0.2 on 2023-07-28 07:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('transaction', '0005_globaltransactiondetails_para_no_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recommender', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='recommender', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'hierarchy_form_level',
                'verbose_name_plural': 'hierarchy_form_level',
                'db_table': 'hierarchy.form_level',
            },
        ),
    ]
